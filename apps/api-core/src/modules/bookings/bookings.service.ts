...
export class BookingsService {
  ...
  async recordPayment(
    ...
    payment.reference = createPaymentDto.reference || undefined;
    payment.notes = createPaymentDto.notes || undefined;
    payment.recordedBy = userId;

    console.log('DEBUG - payment entity before save:', payment);
